...
public class GeneratedTrainingCoreConstants
{
	...
	public static class Attributes
	{
		...
		{
			public static final String ORDERLINEREFERENCENEW = "orderLineReferenceNew".intern();
			public static final String ORDERLINEREFERENCETESTHARD = "orderLineReferenceTestHard".intern();
		}
		public static class Product
		{
			public static final String ISBUYABLE = "isBuyable".intern();
			public static final String PRODUCTSPECIALITY = "productSpeciality".intern();
		}
	}
