...
public class AddToCartController extends AbstractController
{
	...
	final String code, @RequestParam("orderLineReference")
	final String orderLineReference, final Model model, @Valid
	final AddToCartForm form, final BindingResult bindingErrors)
	{
		...
		//final String orderLineReference = form.getOrderLineReferenceNew();
		...
		else
		{
			try
			{
				...
				addToCartParams.setProductCode(code);
				addToCartParams.setOrderLineReferenceNew(orderLineReference);
